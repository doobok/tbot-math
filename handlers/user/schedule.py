...
from utils.keyboards.student_kbd import st_lesson_history_menu, st_pass_history_menu
...
async def st_schedule(msg: types.Message) -> None:
    await msg.answer(await st_schedule_text(msg.from_user.id), reply_markup=st_lesson_history_menu())
