...
from .schedule import st_lesson_history, st_pass_history, st_schedule, st_zoom_url, tutor_zoom
...
def setup(dp: Dispatcher):
    ...
    dp.register_message_handler(st_zoom_url, regexp_commands=['online_([0-9]*)'])
