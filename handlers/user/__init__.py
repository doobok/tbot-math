...
def setup(dp: Dispatcher):
    ...
    dp.register_message_handler(guest_price, regexp_commands=['price_([0-9]*)'], state="*")
    dp.register_callback_query_handler(ordered_price, get_order_callback(None, None), state="*")
